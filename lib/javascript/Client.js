...
function kb_A5(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_A5 = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_A5.run_A5",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_A5.status",
